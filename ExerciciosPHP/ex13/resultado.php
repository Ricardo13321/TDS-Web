            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sw">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-calculator" viewBox="0 3 16 16">
                        ...
                        </svg>&nbsp;&nbsp;<font style="font-size: 30px;"><b>Conversão de Nota Para Conceito</b></font>
                    </div>
                    <div class="card-body">
                        <?php
                            $nota = $_POST['nota'];
                            $text = "a sua nota $nota transformada em conceita é";
                            switch (true) {
                                case $nota <= 10 && $nota >= 9:
                                    echo" $text A";
                                    break;
